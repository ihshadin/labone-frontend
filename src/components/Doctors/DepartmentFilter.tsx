...
//   const [department, setDepartment] = useState([]);
  ...
  return (
  <>
    <div className="w-full py-1.5 px-2 rounded-full backdrop-filter bg-primary/10 bg-opacity-85 border-1 border-primary/30 focus:outline-0 focus:outline-primary focus:border-primary/70 duration-300 transition-all">
        <Select
