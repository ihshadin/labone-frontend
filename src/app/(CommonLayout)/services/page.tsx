      ...
      <div className="mx-auto max-w-[1250px] px-2 py-14 md:py-20 lg:py-28">
        <div>
          ...
          <p className="font-tiroBangla text-lg md:text-xl">
            আমাদের ল্যাব ওয়ান হাসপাতালে, আমরা প্রত্যেক রোগীকে ব্যতিক্রমী যত্ন
            এবং আরাম দেওয়ার জন্য নিবেদিত। আমাদের স্বাস্থ্যসেবা পেশাদারদের
            অত্যন্ত দক্ষ এবং সহানুভূতিশীল দল ব্যক্তিগতকৃত, রোগী-কেন্দ্রিক
