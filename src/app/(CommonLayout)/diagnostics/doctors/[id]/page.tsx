import { getDgDoctor } from "@/api/dg-doctors.api";
...
const DgDoctorSinglePage = async ({ params }: { params: { id: string } }) => {
  const doctor = await getDgDoctor(params?.id);
          ...
          <div className="md:col-span-5">
            ...
            <ul className="mt-2 mb-8 space-y-1 md:space-y-3 hover:*:text-primary *:transition-all hover:*:translate-x-1 *:flex *:flex-wrap md:*:flex-nowrap *:gap-1">
              ...
              <li>
                ...
                <span>Labone diagnostics Hospital</span>
              </li>
            </ul>
...
export default DgDoctorSinglePage;
