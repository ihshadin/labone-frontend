...
import { getDgMachine } from "@/api/dg-machines.api";

const DgMachineDetailsPage = async ({ params }: { params: { id: string } }) => {
  const machine = await getDgMachine(params?.id);
  return (
    <>
...
export default DgMachineDetailsPage;
